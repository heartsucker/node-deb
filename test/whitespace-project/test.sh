...
cd "$(dirname $0)/app"
declare -r output='whitespace-project_0.1.0_all'
...
stat "$output/usr/share/whitespace-project/app/whitespace file.js" > /dev/null
stat "$output/usr/share/whitespace-project/app/whitespace folder/" > /dev/null
stat "$output/usr/share/whitespace-project/app/whitespace folder/file1.js" > /dev/null
